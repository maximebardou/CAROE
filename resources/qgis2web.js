...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-127642.446667, 5741404.986915, -83083.130386, 5789531.887532], maxZoom: 12, minZoom: 11
    })
});
...
map.getView().fit([-127642.446667, 5741404.986915, -83083.130386, 5789531.887532], map.getSize());
